...
const ProductCard = ({ id, title, desc, price, tag, productImg  }: IProps) => {
  ...
  return (
     <div 
        className="flex flex-col gap-[15px] rounded-[15px] w-[300px] h-[400px] border-[1px] border-[#202021] overflow-hidden card_shadow bg-[var(--dark)] cursor-pointer">
        ...
        <div className="flex flex-col h-[50%] justify-between p-[10px]">
            ...
            <div className="h-[50%] flex flex-col gap-[10px] w-full">
              ...
              <CustomButton
                ...
                disabled={false}
                style={`bg-[var(--bright-yellow)] responsive-btnText`}
                      >
