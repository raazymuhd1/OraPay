  ...
  return (
    <div className="w-full h-[300px]  mx-auto rounded-[10px] p-[30px] border-[1px] border-[#202021] bg-brown">
        ...
        <aside className="w-full flex items-center gap-[20px] mt-[20px]">
          <div className="w-[50%] rounded-[10px] border-[1px] border-[#202021] p-[20px] glass-card">
              <div className='flex items-center justify-between'>
               ...
               <div className="flex flex-col gap-[10px] mt-[10px]">
                  ...
                  <p className="text-[#7f7f80] text-[.7vmax]">APY is variable and changes based on market conditions</p>
               </div>
          </div>
