  ...
  return (
    <div className="w-full rounded-[10px] min-h-[300px] p-[30px] bg-brown flex flex-col gap-[10px]">
       <aside>
           ...
           <p className="text-[#7f7f80]"> This section provides projected yield based on your current deposits. Use this information to plan your future purchases in the marketplace. </p>
        </aside>
       ...
       <div className='w-full flex flex-col gap-[15px] glass-card p-[15px]'>
          ...
          <p className="text-[#7f7f80] font-medium"> These projections are based on the current APY of 8.2% and may vary based on market conditions. </p>
       </div>
       ...
       <div className="w-full p-[15px] glass-card">
          <aside className="flex flex-col gap-[10px]">
            ...
            <p className="text-[#7f7f80]"> With your current yield rate, you can purchase the following items from the marketplace: </p>
          </aside>
