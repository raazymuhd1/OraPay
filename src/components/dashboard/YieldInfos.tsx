  ...
  return (
    <aside className="xl:w-[70%] md:w-[90%] w-full mx-auto rounded-[10px] ">
       ...
       <Tabs defaultValue='overview' className=''>
          <TabsList className="grid lg:w-[40%] bg-[var(--dark)] w-full grid-cols-[repeat(3,minmax(100px,1fr))] items-center gap-[5px]">
          ...
          <TabsContent value="overview" className="mt-[20px] bg-[var(--dark)]">
              <YieldOverview />
          </TabsContent>
