  ...
  return (
    <section className="min-h-[600px] flex flex-col items-center justify-center w-full gap-[10px] bg-[rgba(22,22,23,255)] p-[40px]">
        ...
        <div className="flex items-center justify-center flex-wrap w-[80%] gap-[30px] mt-[60px]">
            { intros.map(intro => (
                <div key={intro.id} 
                    className="flex flex-col gap-[10px] basis-[400px] border-[1px] border-[#7f7f80] h-[250px] rounded-[20px] p-[20px] hover:translate-y-[-10px] transition-all duration-500 cursor-pointer intro-card glass-card">
