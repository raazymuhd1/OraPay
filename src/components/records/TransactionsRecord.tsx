...
const TransactionsRecord = ({transactions}: ITxsRecord<string>) => {
  ...
  return (
    <section className={`${showTxsRecord ? "w-full opacity-[1] h-full" : "opacity-[1] h-0 w-0 translate-x-[-100px]"} translate-x-[0px] glass-card transition-all duration-500 overflow-y-auto absolute top-0 left-0`}>
